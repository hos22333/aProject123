...
class FDS_MSf(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        user = kwargs.pop('user', None)  # Get the logged-in user
        super().__init__(*args, **kwargs)
        form_name = 'FDS_MechanicalFineScreen'
...
class FDS_NSc(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        user = kwargs.pop('user', None)  # Get the logged-in user
        super().__init__(*args, **kwargs)
        form_name = 'FDS_ManualCoarseScreen'
...
class FDS_NSf(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        user = kwargs.pop('user', None)  # Get the logged-in user
        super().__init__(*args, **kwargs)
        form_name = 'FDS_ManualFineScreen'
...
class FDS_GR(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        user = kwargs.pop('user', None)  # Get the logged-in user
        super().__init__(*args, **kwargs)
        form_name = 'FDS_GritGreaseRemoval'
...
class FDS_PS(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        user = kwargs.pop('user', None)  # Get the logged-in user
        super().__init__(*args, **kwargs)
        form_name = 'FDS_PrimarySedimentationTank'
